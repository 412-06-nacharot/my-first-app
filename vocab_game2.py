...
ans3 = st.text_input(
     "ข้อ 3: I like `B__c_` color. 🎱",
     value=st.session_state.ans3_val,
)
ans4 = st.text_input(
     "ข้อ 4: My friend's name is `_p__n` .🇪🇸 ",
...
ans3 = st.text_input(
     "ข้อ 3: I like `p_rp__` color. 👾",
     value=st.session_state.ans3_val,
)
ans4 = st.text_input(
     "ข้อ 4: My friend's name is `t__e_` .🐯 ",
     value=st.session_state.ans4_val,
)
...
st.divider()
st.write("นางสาวณชรต นิลพันธุ์ เลขที่ 6 ม.4/12")
